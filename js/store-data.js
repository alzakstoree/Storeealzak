...
export const defaultStoreData = {
    sections: [
            ...
            categories: [
                {
                    id: 'pubg',
                    name: 'PUBG',
                    image: 'https://i.ibb.co/ccXyWp5v/Screenshot-20260309-045801.jpg', // صورة PUBG
                    products: [
                ...
                },
                {
                    id: 'freefire',
                    name: 'Free Fire',
                    image: 'https://i.ibb.co/ghSdR1b/Screenshot-20260309-045833.jpg', // صورة Free Fire
                    products: [
                ...
                },
                {
                    id: 'cod',
                    name: 'Call of Duty',
                    image: 'https://i.ibb.co/qYCBCS7m/Screenshot-20260309-045944.jpg', // صورة Call of Duty
                    products: [
        ...
        },
        {
            ...
            name: 'التطبيقات',
            icon: 'fa-mobile-alt',
            image: 'https://i.ibb.co/S45Nv2TH/Screenshot-20260312-001846.jpg', // صورة غلاف التطبيقات
            categories: [
                {
                    id: 'shahid',
                    name: 'شاهد VIP',
                    image: 'https://i.ibb.co/zTCxDXRc/Screenshot-20260312-220100.jpg', // صورة شاهد
                    products: [
                ...
                },
                {
                    id: 'netflix',
                    name: 'نتفلكس',
                    image: 'https://i.ibb.co/ZpsTsKCT/Screenshot-20260312-215939.jpg', // صورة نتفلكس
                    products: [
