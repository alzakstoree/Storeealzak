    ...
    sections: [
        {
            ...
            name: 'الألعاب',
            icon: 'fa-gamepad',
            image: 'https://i.ibb.co/rRSNhBXc/Screenshot-20260312-002402.jpg',
            categories: [
                {
                    id: 'pubg',
                    name: 'PUBG',
        ...
        },
        {
            ...
            name: 'بطاقات جوجل',
            icon: 'fa-google',
            image: 'https://i.ibb.co/TDCzWdNY/Screenshot-20260312-002552.jpg',
            categories: [
                {
                    id: 'google',
                    name: 'بطاقات جوجل بلاي',
                    image: 'https://i.ibb.co/27L8d2Cv/Screenshot-20260312-220435.jpg',
                    products: [
